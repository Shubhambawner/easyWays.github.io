    ...
    $.fn.CheckAlphabetOnly = function() {
        return this.each((function() {
            $(this).blur((function(e) {
                var control = $(this), str, letters = /^[A-Za-z ]+$/;
                return !!control.val().match(letters) || (swal("", "Please enter alphabets only", "error"),
                setTimeout((function() {
                    $(window).focus(),
                    control.focus()
                }
    ...
    $.fn.CheckAlphaNumericOnly = function() {
        return this.each((function() {
            $(this).blur((function(e) {
                ...
                return !!$(this).val().match(letters) || (swal("", "Alphanumerics in capital only: [AXXXXXXXX67]", "error"),
                !1)
            }
            ))
        }
